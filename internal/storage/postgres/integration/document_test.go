...
func (c *DocumentStorageSuite) Test_IntegrationDocumentStorage_Create(t provider.T) {
...
func (c *DocumentStorageSuite) Test_IntegrationDocumentStorage_GetByID(t provider.T) {
...
func (c *DocumentStorageSuite) Test_IntegrationDocumentStorage_GetByInfoCardID(t provider.T) {
...
func (c *DocumentStorageSuite) Test_IntegrationDocumentStorage_Delete(t provider.T) {
