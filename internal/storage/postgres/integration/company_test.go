...
func (c *CompanyStorageSuite) Test_IntegrationCompanyStorage_Create(t provider.T) {
...
func (c *CompanyStorageSuite) Test_IntegrationCompanyStorage_GetByID(t provider.T) {
...
func (c *CompanyStorageSuite) Test_IntegrationCompanyStorage_Delete(t provider.T) {
